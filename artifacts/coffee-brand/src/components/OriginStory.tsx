    ...
    <section id="origin" className="py-24 md:py-32 bg-background noise-bg relative z-10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="aspect-[4/5] bg-primary/5 rounded-2xl border border-primary/10 overflow-hidden relative p-8 flex flex-col justify-between">
              ...
              <div className="relative z-10 flex justify-end">
                <div className="w-24 h-24 rounded-full bg-white border border-primary/20 flex flex-col items-center justify-center shadow-sm">
                  <span className="font-typewriter text-[10px] text-primary/60 uppercase tracking-widest mb-1">Altura</span>
                  <span className="font-heading text-xl text-primary leading-none">1,700</span>
                  <span className="font-typewriter text-[10px] text-primary/60 uppercase tracking-widest mt-1">Metros</span>
                </div>
              </div>
          ...
          >
            <h2 className="text-primary mb-8 text-4xl md:text-5xl">Where Altitude Meets Perfection</h2>
            
            <div className="space-y-6 text-foreground/80 font-light text-lg">
              <p>
                In the shadow of the Andes, where the cool mountain air meets the warm currents of the Magdalena River valley, lies Huila. This unique microclimate creates an extended maturation process for our coffee cherries, allowing complex sugars to develop slowly.
              </p>
              <p>
                Every bean in a bag of Café Huila is hand-picked by multi-generational farming families who know the exact shade of crimson that signifies readiness. We don't strip-pick; we return to the same tree multiple times throughout the harvest, selecting only perfection.
              </p>
              <p>
                The result is a cup defined by its bright acidity, rich caramel sweetness, and the unmistakable floral notes that have made Huila the most celebrated coffee terroir in Colombia.
              </p>
            </div>

            <div className="mt-10 flex gap-6">
              <div className="flex flex-col gap-2">
                <span className="font-typewriter text-xs text-primary/60 uppercase tracking-widest">Varieties</span>
                <span className="font-medium text-foreground">Caturra, Castillo, Pink Bourbon</span>
              </div>
              <div className="w-px bg-primary/20"></div>
              <div className="flex flex-col gap-2">
                <span className="font-typewriter text-xs text-primary/60 uppercase tracking-widest">Harvest</span>
                <span className="font-medium text-foreground">Sept - Dec & April - June</span>
              </div>
            </div>
          </motion.div>
