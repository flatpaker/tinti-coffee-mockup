...
const products = [
  {
    id: 1,
    name: "Huila Washed Natural",
    notes: "Floral, Tropical Fruit, Panela",
    roast: "Light-Medium",
    price: "$24.00",
    image: "/bag-1.png",
    type: "Single Origin"
  ...
  {
    id: 4,
    name: "Microlot Anaerobic",
    notes: "Strawberry Jam, Fermented, Cacao",
    roast: "Light",
    price: "$34.00",
    image: "/bag-4.png",
    type: "Microlot"
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <motion.div
            ...
            className="max-w-xl"
          >
            <span className="font-typewriter text-sm text-secondary uppercase tracking-widest mb-4 block">The Collection</span>
            <h2 className="text-primary text-4xl md:text-5xl">Sourced From The Source</h2>
          </motion.div>
            ...
            >
              ...
              <div className="p-6 flex flex-col flex-grow bg-white">
                <div className="flex justify-between items-start mb-2">
                  ...
                  <span className="font-sans font-medium text-foreground">{product.price}</span>
                </div>
